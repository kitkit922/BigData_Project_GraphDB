...
//Drivers
CREATE
(FAlonso:Driver { name : "Fernando Alonso", born :1981 }),
(SVettel:Driver { name : "Sebastian Vettel", born :1987 }),
(JButton:Driver { name : "Jenson Button", born : 1980 }),
(LHamilton:Driver { name : "Lewis Hamilton", born :1985 }),
(KRaikkonen:Driver { name : "Kimi Raikkonen", born :1979 }),
(MWebber:Driver { name : "Mark Webber", born :1976 }),
(FelipeMassa:Driver { name : "Felipe Massa", born :1981 }),
(SergioP:Driver { name : "Sergio Pérez", born :1990 }),
(HeikkiKovalainen:Driver { name : "Heikki Kovalainen", born :1981 }),
(RomainGrosjean:Driver { name : "Romain Grosjean", born :1986 }),
(NicoRosberg:Driver { name : "Nico Rosberg", born :1985 }),
(NicoH:Driver { name : "Nico Hülkenberg", born :1987 }),
(EstebanG:Driver { name : "Esteban Gutiérrez", born :1991 }),
(PaulDiResta:Driver { name : "Paul di Resta", born :1986 }),
(AdrianSutil:Driver { name : "Adrian Sutil", born :1983 }),
(PastorMaldonado:Driver { name : "Pastor Maldonado", born :1985 }),
(ValtteriBottas:Driver { name : "Valtteri Bottas", born :1989 }),
(Vergne:Driver { name : "Jean-Éric Vergne", born :1990 }),
(DanielRicciardo:Driver { name : "Daniel Ricciardo", born :1989 }),
(CharlesPic:Driver { name : "Charles Pic", born :1990 }),
(GiedoGarde:Driver { name : "Giedo van der Garde", born :1985 }),
(JulesBianchi:Driver { name : "Jules Bianchi", born :1989 }),
(MaxChilton:Driver { name : "Max Chilton", born :1991 })
...
(SouthKorea:Country { name:"South Korea" }),
...
//Constructors
CREATE
(RedBull:Constructor { name:"Red Bull-Renault" }),
(Ferrari:Constructor { name:"Ferrari" }),
(McLarenMercedes:Constructor { name:"McLaren-Mercedes" }),
(Lotus:Constructor { name:"Lotus-Renault" }),
(Mercedes:Constructor { name:"Mercedes" }),
(Sauber:Constructor { name:"Sauber-Ferrari" }),
(ForceIndia:Constructor { name:"Force India-Mercedes" }),
(Williams:Constructor { name:"Williams-Renault" }),
(ToroRosso:Constructor { name:"Toro Rosso-Ferrari" }),
(Caterham:Constructor { name:"Caterham-Renault" }),
(Marussia:Constructor { name:"Marussia-Cosworth" })
...
//Engines
CREATE
(RS272013:Engine { name:"Reanult RS27-2013" }),
(FerrariType056:Engine { name:"Ferrari Type 056" }),
(MercedesFO108Z:Engine { name:"Mercedes FO 108Z" }),
(CosworthCA2013:Engine { name:"CosworthCA2013" })

//GrandsPrix
CREATE
(Melbourne:GrandPrix { city:"Melbourne", meters:5303 }),
(Sepang:GrandPrix{ city:"Sepang", meters:5543 }),
(Shanghai:GrandPrix{ city:"Shanghai", meters:5451 }),
(Sakhir:GrandPrix{ city:"Sakhir", meters:5412 }),
(Montmelo:GrandPrix{ city:"Montmeló", meters:4655 }),
(MonacoCirc:GrandPrix{ city:"Monaco", meters:3340 }),
(Montreal:GrandPrix{ city:"Montreal", meters:4361 }),
(Silverstone:GrandPrix{ city:"Silverstone", meters:5891 }),
(Nurburg:GrandPrix{ city:"Nürburg", meters:4574 }),
(Budapest:GrandPrix{ city:"Budapest", meters:4328 }),
(SpaFrancorchamps:GrandPrix{ city:"Spa-Francorchamps", meters:7004 }),
(Monza:GrandPrix{ city:"Monza", meters:5793 }),
(SingaporeCirc:GrandPrix{ city:"Singapore", meters:5073 }),
(Yeongam:GrandPrix{ city:"Yeongam", meters:5615 }),
(Suzuka:GrandPrix{ city:"Suzuka", meters:5807 }),
(GreaterNoida:GrandPrix{ city:"Greater Noida", meters:5141 }),
(AbuDhabi:GrandPrix{ city:"Abu Dhabi", meters:5554 }),
(Austin:GrandPrix{ city:"Austin", meters:5500 }),
(SaoPaulo:GrandPrix{ city:"São Paulo", meters:4309 })
